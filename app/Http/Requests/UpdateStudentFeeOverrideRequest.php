...
class UpdateStudentFeeOverrideRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->route('student_fee_override') !== null
            && ($this->user()?->can('update', $this->route('student_fee_override')) ?? false);
    }
