        ...
        <div class="col-md-4">
            <div class="card page-card h-100">
                <div class="card-body p-4">
                    <div class="text-muted small mb-2">Users</div>
        ...
        <div class="col-md-4">
            <div class="card page-card h-100">
                <div class="card-body p-4">
                    ...
                    <div class="h4 mb-0">{{ $users->getCollection()->where('status', 'active')->count() }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card page-card h-100">
                <div class="card-body p-4">
                    <div class="text-muted small mb-2">Inactive on This Page</div>
                    <div class="h4 mb-0">{{ $users->getCollection()->where('status', 'inactive')->count() }}</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
                <form method="GET" action="{{ route('admin.users.index') }}" class="row g-2 w-100 w-lg-auto">
                    <div class="col-12 col-md-auto">
                        <input type="text" name="search" value="{{ $search }}" class="form-control" placeholder="Search by name, username, email, or role">
                    </div>
